...
// Página /bio: no site original em WordPress, o conteúdo é idêntico ao da
// home — muda apenas a mensagem de WhatsApp, voltada para quem chega pelo
// Instagram. Ver PLANEJAMENTO.md, seção 3.
const WHATSAPP_MSG = "Olá, vim através do Instagram e gostaria de mais informações sobre as consultas e especialidades do Dr Arlan!";
